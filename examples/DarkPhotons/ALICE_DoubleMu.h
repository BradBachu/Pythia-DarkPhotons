//------------------------------------------------------------------------------
/// \file ALICE_DoubleMu.h
// Change rapidity requirements to match ALICE so that we can look at MC comparison
//------------------------------------------------------------------------------

#ifndef DarkPhotons_ALICE_DoubleMu_H
#define DarkPhotons_ALICE_DoubleMu_H
...
class ALICE_DoubleMu: public Trigger
{
...
public:
   ...
   ALICE_DoubleMu()
   {
      std::cout<<"Created ALICE_DoubleMu trigger" << std::endl;
   }
...
//------------------------------------------------------------------------------
//------------------------------------------------------------------------------
void ALICE_DoubleMu::initialize()
{
   _passed = false;
   _v_mu.clear();
   _v_mubar.clear();
...
//------------------------------------------------------------------------------
void ALICE_DoubleMu::_sortMuons(Event& event)
{
   // EtaCut _etaCut(1.506);
   EtaCut _etaCut(2.5,4.0);
   PtCut _pTCut(1., 5.);
...
//------------------------------------------------------------------------------
void ALICE_DoubleMu::_saveMuonIndex(Event& event, int i)
{
...
//------------------------------------------------------------------------------ 
bool ALICE_DoubleMu::_checkDeltaRs(Event& event)
{
...
//------------------------------------------------------------------------------
bool ALICE_DoubleMu::_checkNGoodMuons()
{
...
#endif // DarkPhotons_ALICE_DoubleMu_H